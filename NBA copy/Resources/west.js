...
for(var n in westData){
	var tableSection = Ti.UI.createTableViewSection({
		headerTitle: westData[n].headerTitle,
		footerTitle: westData[n].footerTitle
	});
	for ( var i = 0, j = westData[n].rowData.length; i < j ; i++){
	var theRow = Ti.UI.createTableViewRow({
		header: westData[n].headerTitle,
		title: westData[n].rowData[i].name,
		record: westData[n].rowData[i].record,
		rank: westData[n].rowData[i].rank,
		ppg: westData[n].rowData[i].ppg,
		apg: westData[n].rowData[i].apg,
		rpg: westData[n].rowData[i].rpg,
		bpg: westData[n].rowData[i].bpg,
		scorer: westData[n].rowData[i].scorer,
		assist: westData[n].rowData[i].assist,
		fg: westData[n].rowData[i].fg,
		logo: westData[n].rowData[i].logo,
		name1: westData[n].rowData[i].name1,
		name2: westData[n].rowData[i].name2,
		name3: westData[n].rowData[i].name3,
		stat1: westData[n].rowData[i].stat1,
		stat2: westData[n].rowData[i].stat2,
		stat3: westData[n].rowData[i].stat3,
		hasChild: true
	});
